-- Let's check what status values are allowed and use the correct ones
...
-- Insert the official properties with proper status values
...
-- Nest House - using 'inactive' instead of 'occupied'
(
  'Nest House',
